...
class DetailTableViewCell: UITableViewCell {
    ...
    func reloadData(detail: Detail, isSuggestion: Bool) {
        self.itemTitleLabel.text = detail.itemTitle
        if (isSuggestion == true) {
            self.detailLabel.text = detail.itemSuggestion
            self.levelLabel.isHidden = true
        } else {
            self.detailLabel.text = detail.itemDes
            self.levelLabel.text = detail.itemLevel
        }
    }
